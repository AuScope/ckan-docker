...
def declaration_validator(value):
    """
    Make sure the Dataset Submission Guildelines have been accepted
    """
    if not value or value is tk.missing or value == 'False':
        raise tk.Invalid(tk._("You must accept the Dataset Submission Guildelines"))
    return value
